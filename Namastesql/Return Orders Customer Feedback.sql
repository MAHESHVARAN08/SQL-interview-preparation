...
-- Solution
select customer_name, round(count(r.order_id)*100.0/count(o.order_id),2) as return_percent from orders as o
left join returns as r
on o.order_id = r.order_id
group by customer_name
having round(count(r.order_id)*100/count(o.order_id),2) > 50
